...
# app.py — Streamlit Box Office Predictor
...
Powered by an ensemble of XGBoost, LightGBM & RandomForest models.
""")
...
with col1:
    ...
    vote_count    = st.number_input("Expected Vote Count", 100, 100000, 1000)
...
with col2:
    ...
    genres        = st.multiselect("Genres", ALL_GENRES, default=["Action", "Adventure"])
...
if st.button("🔮 Predict Box Office Revenue", type="primary", use_container_width=True):
    ...
    from notebook_inference import predict_new_movie  # from your exported notebook
